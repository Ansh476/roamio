          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:block">
              <ul className="flex items-center gap-6 ">
                ...
                <li className='py-4'>
                    <NavLink to="/blogs" className={({ isActive }) => isActive ? 'active' : undefined} onClick={() => window.scrollTo(0, 0)}>
                    Blogs
                    </NavLink>
                </li>
                <li className='py-4'>
                    <NavLink to="/places" className={({ isActive }) => isActive ? 'active' : undefined} onClick={() => window.scrollTo(0, 0)}>
                    Best Places
                    </NavLink>
                </li>
                <li className='py-4'>
            ...
            <div className="flex items-center gap-4">
              <NavLink
                to="/target-route"
                className={({ isActive }) => 
                  isActive ? "text-blue-600 underline" : "text-blue-500 hover:underline"
                }
                onClick={() => {
